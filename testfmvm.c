...
int main(void)
{
   ...
   str = mvm_print(m);
   i = strcmp(str, "[cat](meow) [dog](bark) [horse](neigh) [frog](croak) [bird](tweet) ");
   assert(i==0);
   free(str);
   ...
   assert(mvm_size(m)==4);
   str = mvm_print(m);
   i = strcmp(str, "[cat](meow) [horse](neigh) [frog](croak) [bird](tweet) ");
   assert(i==0);
   free(str);
   mvm_delete(m, "frog");
   assert(mvm_size(m)==3);
   ...
   assert(mvm_size(m)==4);
   str = mvm_print(m);
   i = strcmp(str, "[cat](meow) [horse](neigh) [frog](ribbit) [frog](croak) [bird](tweet) ");
   free(str);
   assert(i==0);
